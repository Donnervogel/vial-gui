...
themes = [
    ...
    ("Dark", {
        ...
        (QPalette.Disabled, QPalette.Light): "#181818",
    }),
    ("Test", {
        QPalette.Window: "#ff0000",
        QPalette.WindowText: "#0fffff",
        QPalette.Base: "#00ff00",
        QPalette.AlternateBase: "#0000ff",
        QPalette.ToolTipBase: "#ffff00",
        QPalette.ToolTipText: "#f0ffff",
        QPalette.Text: "#ffffff",
        QPalette.Button: "#ff00ff",
        QPalette.ButtonText: "#ffffff",
        QPalette.BrightText: "#ff0000",
        QPalette.Link: "#f7a948",
        QPalette.Highlight: "#000fff",
        QPalette.HighlightedText: "#fff000",
        (QPalette.Active, QPalette.Button): "#0f0f0f",
        (QPalette.Disabled, QPalette.ButtonText): "#f00f0f",
        (QPalette.Disabled, QPalette.WindowText): "#0ff0f0",
        (QPalette.Disabled, QPalette.Text): "#ff0000",
        (QPalette.Disabled, QPalette.Light): "#00ff00",
    }),
    ("Arc", {
